/**
 * API de Mercados - Buscar dados de mercado do Finnhub
 *
...
/**
 * Criar um item de mercado vazio (usado para estados de erro/dados faltando)
 */
...
/**
 * Criar um item de performance de setor vazio
 */
...
/**
 * Buscar preços de criptomoedas do CoinGecko via proxy
 */
...
/**
 * Buscar índices de mercado do Finnhub
 */
...
/**
 * Buscar performance de setores do Finnhub (usando ETFs setoriais)
 */
