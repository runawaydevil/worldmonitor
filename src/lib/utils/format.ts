...
/**
 * Formata tempo relativo a partir de uma data
 */
...
/**
 * Obtém tempo relativo com mais detalhes
 */
...
export function formatCurrency(
	...
	return symbol + value.toLocaleString('pt-BR', { maximumFractionDigits: decimals });
}
