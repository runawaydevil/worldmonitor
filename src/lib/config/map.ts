...
export const HOTSPOTS: Hotspot[] = [
	...
	},
	{
		...
		lon: -47.9,
		level: 'low',
		desc: 'Brasília — Capital do Brasil, centro político, Congresso Nacional, Palácio do Planalto'
	},
	{
		name: 'São Paulo',
		lat: -23.55,
		lon: -46.63,
		level: 'low',
		desc: 'São Paulo — Maior cidade do Brasil, centro econômico e financeiro'
	},
	{
		name: 'Rio de Janeiro',
		lat: -22.9,
		lon: -43.2,
		level: 'low',
		desc: 'Rio de Janeiro — Centro político e econômico, sede de grandes empresas'
	},
	{
		name: 'Belo Horizonte',
		lat: -19.9,
		lon: -43.9,
		level: 'low',
		desc: 'Belo Horizonte — Centro industrial de Minas Gerais'
	},
	{
		name: 'Curitiba',
		lat: -25.4,
		lon: -49.3,
		level: 'low',
		desc: 'Curitiba — Centro tecnológico do Sul do Brasil'
	},
	{
		name: 'Porto Alegre',
		lat: -30.0,
		lon: -51.2,
		level: 'low',
		desc: 'Porto Alegre — Centro regional do Rio Grande do Sul'
	},
	{
		name: 'Recife',
		lat: -8.05,
		lon: -34.9,
		level: 'low',
		desc: 'Recife — Centro regional do Nordeste'
	},
	{
		name: 'Salvador',
		lat: -12.97,
		lon: -38.5,
		level: 'low',
		desc: 'Salvador — Centro regional do Nordeste, capital da Bahia'
	},
	{
		name: 'Manaus',
		lat: -3.1,
		lon: -60.0,
		level: 'low',
		desc: 'Manaus — Zona Franca de Manaus, centro industrial da Amazônia'
	},
	{
		name: 'Belém',
		lat: -1.45,
		lon: -48.5,
		level: 'elevated',
		desc: 'Belém — Amazônia, questões ambientais e desmatamento'
	}
];
