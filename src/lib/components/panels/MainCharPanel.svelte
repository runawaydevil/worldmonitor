...
<Panel id="mainchar" title={PANELS.mainchar.name}>
	{#if !topChar}
		<div class="empty-state">Ainda sem dados</div>
	{:else}
		<div class="main-char-display">
			<div class="main-char-label">Personagem Principal de Hoje</div>
			<div class="main-char-name">{topChar.name}</div>
			<div class="main-char-count">{topChar.count} menções em manchetes</div>
